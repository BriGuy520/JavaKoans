...
public class AboutStrings {
    ...
    public void implicitStrings() {
        assertEquals("just a plain ole string".getClass(), "another string that is pretty plain".getClass());
    }
    ...
    public void newString() {
        ...
        String empty = "";
        assertEquals(string.equals(empty), "".equals(new String()));
    }
    ...
    public void newStringIsRedundant() {
        ...
        assertEquals(stringInstance.equals(stringReference), "one".equals(new String("one")));
    }
    ...
    public void newStringIsNotIdentical() {
        String stringInstance = "zero";
        String stringReference = new String(stringInstance);
        assertEquals(stringInstance == stringReference, "one" == new String("one"));
    }
